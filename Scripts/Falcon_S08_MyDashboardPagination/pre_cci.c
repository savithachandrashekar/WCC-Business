# 1 "e:\\performance\\css\\fy21\\wccbusiness\\scripts\\itg\\v1\\falcon_s08_mydashboardpagination\\\\combined_Falcon_S08_MyDashboardPagination.c"
...
# 1 "e:\\performance\\css\\fy21\\wccbusiness\\scripts\\itg\\v1\\falcon_s08_mydashboardpagination\\\\combined_Falcon_S08_MyDashboardPagination.c" 2
...
# 2 "e:\\performance\\css\\fy21\\wccbusiness\\scripts\\itg\\v1\\falcon_s08_mydashboardpagination\\\\combined_Falcon_S08_MyDashboardPagination.c" 2
...
# 3 "e:\\performance\\css\\fy21\\wccbusiness\\scripts\\itg\\v1\\falcon_s08_mydashboardpagination\\\\combined_Falcon_S08_MyDashboardPagination.c" 2
...
# 4 "e:\\performance\\css\\fy21\\wccbusiness\\scripts\\itg\\v1\\falcon_s08_mydashboardpagination\\\\combined_Falcon_S08_MyDashboardPagination.c" 2
...
Login()
{
	...
	web_url("login_2", 
		"URL=https://{BaseURL}/hp-pps-services/auth/login?cc=us&lc=en&silentCheck=true&pageurl=https://{BaseURL}/{p_locale}", 
		"TargetFrame=", 
		"Resource=0", 
		"Referer=https://{BaseURL}/{p_locale}", 
		"Snapshot=t121.inf", 
...
# 5 "e:\\performance\\css\\fy21\\wccbusiness\\scripts\\itg\\v1\\falcon_s08_mydashboardpagination\\\\combined_Falcon_S08_MyDashboardPagination.c" 2
...
Pagination()
{
	...
	lr_end_transaction("FP23_Pagination_01_dashboard", 2);
	...
	lr_end_transaction("FP23_Pagination_02_api_region", 2);
	...
	lr_end_transaction("FP23_Pagination_03_api_ssc-global", 2);
	...
	lr_end_transaction("FP23_Pagination_04_api_user", 2);
	...
	lr_end_transaction("FP23_Pagination_05_api_termbase-dashboard", 2);
	...
	lr_end_transaction("FP23_Pagination_06_api_wcc_second_Nav", 2);
	...
	lr_end_transaction("FP23_Pagination_07_api_wcc_sitehome_alerts", 2);
	...
	lr_end_transaction("FP23_Pagination_08_api_wcc_FP02_Dashboard_navmenu", 2);
	...
	lr_end_transaction("FP23_Pagination_09_api_devices-all_1", 2);
	...
	lr_end_transaction("FP23_Pagination_10_api_devices-all_2", 2);
	...
	lr_end_transaction("FP23_Pagination_11_api_href", 2);
		
	return 0;
}
# 6 "e:\\performance\\css\\fy21\\wccbusiness\\scripts\\itg\\v1\\falcon_s08_mydashboardpagination\\\\combined_Falcon_S08_MyDashboardPagination.c" 2
...
# 7 "e:\\performance\\css\\fy21\\wccbusiness\\scripts\\itg\\v1\\falcon_s08_mydashboardpagination\\\\combined_Falcon_S08_MyDashboardPagination.c" 2
