# 1 "e:\\performance\\css\\fy21\\wccbusiness\\scripts\\itg\\v1\\falcon_s07_mydashboardcases\\\\combined_Falcon_S07_MyDashboardCases.c"
...
# 1 "e:\\performance\\css\\fy21\\wccbusiness\\scripts\\itg\\v1\\falcon_s07_mydashboardcases\\\\combined_Falcon_S07_MyDashboardCases.c" 2
...
# 2 "e:\\performance\\css\\fy21\\wccbusiness\\scripts\\itg\\v1\\falcon_s07_mydashboardcases\\\\combined_Falcon_S07_MyDashboardCases.c" 2
...
# 3 "e:\\performance\\css\\fy21\\wccbusiness\\scripts\\itg\\v1\\falcon_s07_mydashboardcases\\\\combined_Falcon_S07_MyDashboardCases.c" 2
...
vuser_init()
{
	...
	lr_end_transaction("FP00_Login_01_LaunchURL", 2);
	lr_think_time(1);
	...
	lr_end_transaction("FP00_Login_02_ClickOnPreSigninButton",2);
	...
	lr_end_transaction("FP00_Login_03_EnterUsernameAndClickOnNext",2);
	...
	lr_end_transaction("FP00_Login_04_EnterPassword",2);
	...
	lr_end_transaction("FP00_Login_05_GlobalNavSignin", 2);
	...
	lr_end_transaction("FP00_Login_06_FalconSignIn", 2);
...
# 4 "e:\\performance\\css\\fy21\\wccbusiness\\scripts\\itg\\v1\\falcon_s07_mydashboardcases\\\\combined_Falcon_S07_MyDashboardCases.c" 2
...
{	
	...
	lr_start_transaction("FP00_Login_04_EnterPasswordAndClickOnSignIn");
	...
	lr_end_transaction("FP00_Login_04_EnterPasswordAndClickOnSignIn",2);
	lr_think_time(1);
	 
	return 0;
}
# 5 "e:\\performance\\css\\fy21\\wccbusiness\\scripts\\itg\\v1\\falcon_s07_mydashboardcases\\\\combined_Falcon_S07_MyDashboardCases.c" 2
...
MyDashboard()
{
	...
	lr_end_transaction("FP22_Dashboard_01_doc",2);
	...
	lr_end_transaction("FP22_Dashboard_02_api_region",2);
	...
	web_url("dashboard", 
	  ...
	  lr_end_transaction("FP22_Dashboard_03_api_termbase-dashboard",2);
	...
	lr_end_transaction("FP22_Dashboard_04_api_wcc_second_Nav",2);
	...
	lr_end_transaction("FP22_Dashboard_05_api_wcc_Dashboard_ssr_options",2);
	...
	lr_end_transaction("FP22_Dashboard_06_api_wcc_sitehome_alerts",2);
	...
	lr_end_transaction("FP22_Dashboard_07_api_userlogin",2);
	...
	lr_end_transaction("FP22_Dashboard_08_api_wcc_Dashboard_navmenu",2);
	...
	lr_end_transaction("FP22_Dashboard_09_api_devices-all",2);
	...
	lr_end_transaction("FP22_Dashboard_10_api_href",2);
	
	return 0;
}
# 6 "e:\\performance\\css\\fy21\\wccbusiness\\scripts\\itg\\v1\\falcon_s07_mydashboardcases\\\\combined_Falcon_S07_MyDashboardCases.c" 2
...
Cases()
{
	...
	lr_end_transaction("FP22_Dashboard_11_Device_api_summary",2);
	...
	lr_end_transaction("FP22_Dashboard_12_Cases_api_cases-all",2);
	...
	web_url("{cp_CaseID_Select}", 
		...
		"Mode=HTML", 
		"LAST");
	lr_end_transaction("FP22_Dashboard_13_Device_api_device_casedetails",2);

	
	return 0;
}
# 7 "e:\\performance\\css\\fy21\\wccbusiness\\scripts\\itg\\v1\\falcon_s07_mydashboardcases\\\\combined_Falcon_S07_MyDashboardCases.c" 2
...
# 8 "e:\\performance\\css\\fy21\\wccbusiness\\scripts\\itg\\v1\\falcon_s07_mydashboardcases\\\\combined_Falcon_S07_MyDashboardCases.c" 2
