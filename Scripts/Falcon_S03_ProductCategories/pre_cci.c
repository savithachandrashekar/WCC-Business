# 1 "e:\\performance\\css\\fy21\\wccbusiness\\scripts\\itg\\v1\\falcon_s03_productcategories\\\\combined_Falcon_S03_ProductCategories.c"
...
# 1 "e:\\performance\\css\\fy21\\wccbusiness\\scripts\\itg\\v1\\falcon_s03_productcategories\\\\combined_Falcon_S03_ProductCategories.c" 2
...
# 2 "e:\\performance\\css\\fy21\\wccbusiness\\scripts\\itg\\v1\\falcon_s03_productcategories\\\\combined_Falcon_S03_ProductCategories.c" 2
...
# 3 "e:\\performance\\css\\fy21\\wccbusiness\\scripts\\itg\\v1\\falcon_s03_productcategories\\\\combined_Falcon_S03_ProductCategories.c" 2
...
# 4 "e:\\performance\\css\\fy21\\wccbusiness\\scripts\\itg\\v1\\falcon_s03_productcategories\\\\combined_Falcon_S03_ProductCategories.c" 2

# 1 "ProductCategory_Landing.c" 1
ProductCategory_Landing()
{
	...
	lr_end_transaction("FP12_ProductCategoryLanding_01_doc", 2);
	lr_think_time(1);
	...
	web_custom_request("productLanding", 
		...
		"Mode=HTTP", 
		"LAST");
	lr_end_transaction("FP12_ProductCategoryLanding_02_api_wcc-service-ssc", 2);
	lr_think_time(1);
	...
	web_custom_request("region", 
		...
		"Mode=HTTP", 
		"LAST");
	lr_end_transaction("FP12_ProductCategoryLanding_03_api_region", 2);
	lr_think_time(1);
	...
	lr_end_transaction("FP12_ProductCategoryLanding_04_api_Termbase", 2);
	lr_think_time(1);
	...
	lr_end_transaction("FP12_ProductCategoryLanding_05_api_wcc_second_Nav", 2);
	lr_think_time(1);
	...
	lr_end_transaction("FP12_ProductCategoryLanding_06_api_wcc_pfinder_common", 2);
	lr_think_time(1);
	...
	lr_end_transaction("FP12_ProductCategoryLanding_07_api_wcc_sitehome_alerts", 2);
	lr_think_time(1);
	...
	lr_end_transaction("FP12_ProductCategoryLanding_08_api_wcc_products_banner", 2);
	lr_think_time(1);
	...
	lr_end_transaction("FP12_ProductCategoryLanding_09_api_wcc_products_category", 2);
	lr_think_time(1);
	...
	lr_end_transaction("FP12_ProductCategoryLanding_10_api_active-products", 2);
	lr_think_time(1);
	
 
# 207 "ProductCategory_Landing.c"
	
	

	return 0;
}
# 5 "e:\\performance\\css\\fy21\\wccbusiness\\scripts\\itg\\v1\\falcon_s03_productcategories\\\\combined_Falcon_S03_ProductCategories.c" 2

# 1 "ProductCategoryPrinter_L0.c" 1
ProductCategoryPrinter_L0()
{
	...
	web_custom_request("{p_ProductCategory_L0}", 
		...
		"Mode=HTTP", 
		"LAST");
	lr_end_transaction("FP13_ProductCategoryL0_01_doc", 2);
	lr_think_time(1);
	...
	lr_end_transaction("FP13_ProductCategoryL0_02_api_region", 2);
	lr_think_time(1);
	...
	web_custom_request("productLanding_3", 
		...
		"Mode=HTTP", 
		"LAST");
	lr_end_transaction("FP13_ProductCategoryL0_03_api_termbase", 2);
	lr_think_time(1);
	...
	lr_end_transaction("FP13_ProductCategoryL0_04_api_wcc-service-ssc", 2);
	lr_think_time(1);
	...
	web_custom_request("wcc_second_Nav_2", 
		...
		"Mode=HTTP", 
		"LAST");
	lr_end_transaction("FP13_ProductCategoryL0_05_api_wcc_second_Nav", 2);
	lr_think_time(1);
	...
	web_custom_request("wcc_sitehome_alerts_2", 
		...
		"Mode=HTTP", 
		"LAST");
	lr_end_transaction("FP13_ProductCategoryL0_06_api_wcc_sitehome_alerts", 2);
	lr_think_time(1);
	...
	lr_end_transaction("FP13_ProductCategoryL0_07_api_wcc_pfinder_common", 2);
	lr_think_time(1);
	...
	web_custom_request("getProductCategoriesBySeoName", 
		...
		"LAST");
	lr_end_transaction("FP13_ProductCategoryL0_08_api_getProductCategoriesBySeoName", 2);
	lr_think_time(1);
	...
	lr_end_transaction("FP13_ProductCategoryL0_09_api_wcc_products_banner", 2);
	lr_think_time(1);
	...
	lr_end_transaction("FP13_ProductCategoryL0_10_api_href", 2);
	lr_think_time(1);
	...
	lr_end_transaction("FP13_ProductCategoryL0_11_seo",2);
	
	(web_remove_auto_header("User-Agent", "ImplicitGen=Yes", "LAST"));

	return 0;
}
# 6 "e:\\performance\\css\\fy21\\wccbusiness\\scripts\\itg\\v1\\falcon_s03_productcategories\\\\combined_Falcon_S03_ProductCategories.c" 2

# 1 "ProductCategoryPrinter_L1.c" 1
ProductCategoryPrinter_L1()
{
	...
	web_custom_request("{p_ProductCategory_L1}", 
		...
		"Mode=HTTP", 
		"LAST");
	lr_end_transaction("FP14_ProductCategoryL1_01_doc", 2);
	lr_think_time(1);
	...
	lr_end_transaction("FP14_ProductCategoryL1_02_api_wcc-service-ssc", 2);
	lr_think_time(1);
	...
	lr_end_transaction("FP14_ProductCategoryL1_03_api_wcc_second_Nav", 2);
	lr_think_time(1);
	...
	web_custom_request("region_3", 
		...
		"Mode=HTTP", 
		"LAST");
	lr_end_transaction("FP14_ProductCategoryL1_04_api_region", 2);
	lr_think_time(1);
	...
	web_custom_request("wcc_sitehome_alerts_3", 
		...
		"Mode=HTTP", 
		"LAST");
	lr_end_transaction("FP14_ProductCategoryL1_05_api_wcc_sitehome_alerts", 2);
	lr_think_time(1);
	...
	web_custom_request("productLanding_6", 
		...
		"Mode=HTTP", 
		"LAST");
	lr_end_transaction("FP14_ProductCategoryL1_06_api_termbase", 2);
	lr_think_time(1);
	...
	web_custom_request("wcc_pfinder_common_3", 
		...
		"Mode=HTTP", 
		"LAST");
	lr_end_transaction("FP14_ProductCategoryL1_07_api_wcc_pfinder_common", 2);
	lr_think_time(1);
	...
	lr_end_transaction("FP14_ProductCategoryL1_08_api_wcc_products_banner", 2);
	lr_think_time(1);
	...
	lr_end_transaction("FP14_ProductCategoryL1_09_api_getProductCategoriesBySeoName", 2);
	lr_think_time(1);
	...
	lr_end_transaction("FP14_ProductCategoryL1_10_api_href", 2);
	lr_think_time(1);
	...
	lr_end_transaction("FP14_ProductCategoryL1_11_seo",2);
	
	(web_remove_auto_header("User-Agent", "ImplicitGen=Yes", "LAST"));

	return 0;
}
# 7 "e:\\performance\\css\\fy21\\wccbusiness\\scripts\\itg\\v1\\falcon_s03_productcategories\\\\combined_Falcon_S03_ProductCategories.c" 2

# 1 "ProductCategoryPrinter_L2.c" 1
ProductCategoryPrinter_L2()
{
	...
	web_custom_request("{p_ProductCategory_L2}", 
		...
		"Mode=HTTP", 
		"LAST");
	lr_end_transaction("FP15_ProductCategoryL2_01_doc", 2);
	lr_think_time(1);
	...
	lr_end_transaction("FP15_ProductCategoryL2_02_api_region", 2);
	lr_think_time(1);
	...
	web_custom_request("productLanding_7", 
		...
		"Mode=HTTP", 
		"LAST");
	lr_end_transaction("FP15_ProductCategoryL2_03_api_wcc-service-ssc", 2);
	lr_think_time(1);
	...
	web_custom_request("productLanding_8", 
		...
		"Mode=HTTP", 
		"LAST");
	lr_end_transaction("FP15_ProductCategoryL2_04_api_termbase", 2);
	lr_think_time(1);
	...
	web_custom_request("wcc_sitehome_alerts_4", 
		...
		"Mode=HTTP", 
		"LAST");
	lr_end_transaction("FP15_ProductCategoryL2_05_api_wcc_sitehome_alerts", 2);
	lr_think_time(1);
	...
	web_custom_request("wcc_second_Nav_4", 
		...
		"Mode=HTTP", 
		"LAST");
	lr_end_transaction("FP15_ProductCategoryL2_06_api_wcc_second_Nav", 2);
	lr_think_time(1);
	...
	web_custom_request("wcc_pfinder_common_4", 
		...
		"Mode=HTTP", 
		"LAST");
	lr_end_transaction("FP15_ProductCategoryL2_07_api_wcc_pfinder_common", 2);
	lr_think_time(1);
	...
	lr_end_transaction("FP15_ProductCategoryL2_08_api_wcc_products_banner", 2);
	lr_think_time(1);
	...
	web_custom_request("getProductCategoriesBySeoName_3", 
		...
		"LAST");
	lr_end_transaction("FP15_ProductCategoryL2_09_api_getProductCategoriesBySeoName", 2);
	lr_think_time(1);
	...
	lr_end_transaction("FP15_ProductCategoryL2_10_api_href", 2);
	lr_think_time(1);
	...
	lr_end_transaction("FP15_ProductCategoryL2_11_seo",2);
	
	(web_remove_auto_header("User-Agent", "ImplicitGen=Yes", "LAST"));	

	return 0;
}
# 8 "e:\\performance\\css\\fy21\\wccbusiness\\scripts\\itg\\v1\\falcon_s03_productcategories\\\\combined_Falcon_S03_ProductCategories.c" 2
...
ServiceCenter()
{
	...
	web_url("service-center", 
		...
		"Mode=HTML", 
		"LAST");
	lr_end_transaction("FP26_ServiceCenter_01_doc", 2);
	...
	lr_end_transaction("FP26_ServiceCenter_02_api_Filters", 2);
	...
	lr_end_transaction("FP26_ServiceCenter_03_api_countries", 2);
	...
	web_custom_request("centers", 
		...
		"LAST");
	lr_end_transaction("FP26_ServiceCenter_04_api_centers", 2);

	
	return 0;
}
# 9 "e:\\performance\\css\\fy21\\wccbusiness\\scripts\\itg\\v1\\falcon_s03_productcategories\\\\combined_Falcon_S03_ProductCategories.c" 2
...
# 10 "e:\\performance\\css\\fy21\\wccbusiness\\scripts\\itg\\v1\\falcon_s03_productcategories\\\\combined_Falcon_S03_ProductCategories.c" 2
